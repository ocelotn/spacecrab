...
#		further image testing
	$minimalnodetext = '<div class="story" fg="FGxyzzy" bg="BGxysoemthign"><p> text <a href="" data-dest1id="node1" data-dest2id="node2.node">choice</a></p></div>';	
...
#	grabNodeData
#		normal conditions
	ok(SpaceCrab::grabNodeData('nodeminimal')->{'story'} eq '<div class="story" fg="FGminim"><p>Some text<a data-dest1id="node1" href="spacecrab.pl?node1">choice</a></p></div>', "Grab node data returns link adjusted node contents for valid node");
